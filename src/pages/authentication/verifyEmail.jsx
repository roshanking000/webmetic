...
const VerifyEmail = () => {
  ...
  useEffect(() => {
    if (searchParams.get("verifyCode") !== null)
      setVerificationCode(searchParams.get("verifyCode"));
  }, [searchParams]);
  ...
  const handleVerifyEmail = async () => {
    ...
    await axios
      .post(
        ...
        }/auth/signup/verifyemail/${verificationCode}`
      )
      .then((response) => {
        setLoadingView(false);
        if (response.data.status === "success")
          navigate("/signin", { state: "Email verified successfully" });
        ...
        <div className="relative flex flex-col bg-main justify-center w-full">
          ...
          <div className="flex flex-col justify-center gap-8 sm:w-1/2 mx-auto px-4">
            ...
            <div className="flex flex-col gap-[10px]">
              <p>
                Verification Code <span className="text-[#E03137]">*</span>
              </p>
              <input
                type="text"
            ...
            <button
              ...
              className={clsx(
                ...
                verificationCode === "" || loadingView === true
                  ? "cursor-not-allowed bg-primary-400"
                  : "bg-primary-500"
              )}
              disabled={
                verificationCode === "" || loadingView === true ? true : false
              }
